...
LABEL org.opencontainers.image.description="A multi-stage Docker build that produces a slim golangci-lint container and a CodeClimate engine container for GitLab CI"
